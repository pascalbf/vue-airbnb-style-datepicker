(function (global, factory) {
  ...
  var script = {
    ...
    methods: {
      ...
      handleKeyboardInput: function handleKeyboardInput(event) {
        ...
        } else if (this.showKeyboardShortcutsMenu) ; else if (this.shouldHandleInput(event, this.keys.arrowDown)) {
      ...
      setFocusedDate: function setFocusedDate(date) {
        ...
        var dateElement = this.$refs[("date-" + formattedDate)]; // handle .focus() on ie11 by adding a short timeout
      ...
      isHoveredInRange: function isHoveredInRange(date) {
        ...
        return is_after(date, this.selectedDate1) && is_before(date, this.hoverDate) || is_after(date, this.hoverDate) && is_before(date, this.selectedDate1);
      },
      ...
      customizedDateClass: function customizedDateClass(date) {
        ...
        if (this.customizedDates.length > 0) {
          for (var i = 0; i < this.customizedDates.length; i++) {
            if (this.customizedDates[i].dates.indexOf(date) > -1) { customizedClasses += " asd__day--" + (this.customizedDates[i].cssClass); }
          }
        }
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var AirbnbStyleDatepicker = normalizeComponent_1(
